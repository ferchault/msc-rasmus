...
trajectory_A_5, bulk_water_A_5 = analysis_obj_A.hbond_bulkwater_analysis_build_structure_bulkwater(data_directory + "bulk_oxygen_5.out", data_directory + "filled_hb_db.out")
