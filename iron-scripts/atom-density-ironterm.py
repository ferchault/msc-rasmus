...
oxygen_hist = np.histogram(oxygen_dist, bins=nbins, range=(0.0,12.0), density=False)
...
total_frames = AB_frame['A'] + AB_frame['B']
hydrogen_hist = np.histogram(hydrogen_dist, bins=nbins, range=(0.0,12.0), density=False)
...
total_frames = AB_frame['A'] + AB_frame['B']
iron_hist = np.histogram(iron_dist, bins=nbins, range=(0.0,12.0), density=False)
...
total_frames = AB_frame['A'] + AB_frame['B']
oxygen_water_hist = np.histogram(oxygen_water_dist, bins=nbins, range=(0.0,12.0), density=False)
...
total_frames = AB_frame['A'] + AB_frame['B']
hydrogen_water_hist = np.histogram(hydrogen_water_dist, bins=nbins, range=(0.0,12.0), density=False)
