...
traj_A.start_h_bond_analysis(oxygen_list, hydrogen_list, 300, traj_A.u.trajectory.n_frames, 'run.out')

traj_B = Analysis(base_path + 'IO3-index.xyz', base_path + 'IO3-B.dcd', base_path + 'input.ndx', 'B')
traj_B.set_parameters(3.5, 160)

traj_B.start_h_bond_analysis(oxygen_list, hydrogen_list, 300, traj_B.u.trajectory.n_frames, 'run.out', True)
